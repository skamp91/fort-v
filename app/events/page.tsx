      ...
      try {
        ...
        const mockEvents = [
          ...
          },
          {
            ...
            date: `${currentYear}-${formattedCurrentMonth < 12 ? formattedCurrentMonth + 1 : "01"}-05`, // Next month
            time: "18:00 - 20:00",
            location: "Vereinshaus",
            description: "Halbjährliche Mitgliederversammlung mit Bericht des Vorstands.",
            category: "versammlung",
          },
          {
            id: "5",
            title: "Erntefest",
            date: `${currentYear}-${formattedCurrentMonth < 11 ? formattedCurrentMonth + 2 : "02"}-12`, // Two months ahead
            time: "14:00 - 19:00",
            location: "Festwiese",
            description: "Gemeinsames Feiern der Ernte mit Verkostung und Austausch.",
            category: "fest",
          },
          {
            id: "6",
            title: "Workshop: Garten winterfest machen",
            date: `${currentYear}-${formattedCurrentMonth < 10 ? formattedCurrentMonth + 3 : "03"}-08`, // Three months ahead
            time: "15:00 - 17:00",
            location: "Gemeinschaftsgarten",
            description: "Tipps und praktische Übungen zur Vorbereitung des Gartens auf den Winter.",
            category: "workshop",
          },
        ]
  ...
  return (
    <div className="container px-4 py-12 md:px-6 md:py-16 lg:py-20">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-green-600">Veranstaltungen</h1>
        <p className="mt-4 text-gray-500 md:text-xl">
          Entdecken Sie unsere kommenden Veranstaltungen und werden Sie Teil unserer aktiven Gemeinschaft.
        </p>
      </div>
      ...
      {filteredEvents.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <p className="text-gray-500">
            Keine Veranstaltungen für {getMonthName(currentMonth)} {currentYear} gefunden.
          </p>
          <Button
            variant="outline"
            className="mt-4"
